 ...
 * 环境变量：export MT_PROVINCE="名称"  // 省份
 * 环境变量：export MT_CITY="名称"  // 城市
 * 环境变量：export MT_DISTRICT="区|区"  // 需要申购的区域，多个区域以 | 隔开，留空为随机申购全市所有门店
...
!(async () => {
  ...
  for (let i = 0; i < CookieArr.length; i++) {
    ...
    console.log(`\n======== 账号${i + 1} ========\n`);let randomInt = Math.floor(Math.random() * 60);
        console.log(`\n随机等待 ${randomInt} 秒\n`);
